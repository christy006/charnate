...
class OrganizationForm(FlaskForm):
    ...
    types=SelectField("Type",choices=[("Nonprofit","Nonprofit"), ("Corporation","Corporation")])
    category=SelectField("Category",choices=[("Educational","Educational"), ("Health","Health"), ("Environment", "Environment"), ("Cultural","Cultural"), ("Other","Other")])
